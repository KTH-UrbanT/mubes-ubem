...
if __name__ == '__main__':
    ...
    PathInputFile = 'ExergiProject1.txt'#'MinnebergLast.txt'#'Hammarby0401.txt'#'Pathways_Template.txt'# 'Hammarby0401.txt'#'Pathways_Template.txt'#'Sodermalm4.txt'  #'MinnebergLast.txt'#'Minneberg2D.txt'#'Sodermalm4.txt'##
    CorePerim = False
    FloorZoning = False
    PlotBuilding = False
    ZoneOfInterest = ''
