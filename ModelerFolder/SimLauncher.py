...
# ZoneOfInterest = 'String'             #Text file with Building's ID that are to be considered withoin the BuildNum list, if '' than all building in BuildNum will be considered
    ...
    CaseName = 'minneberg2dfloorzone4devnew'
    BuildNum = []#Bld2Sim
    ...
    FloorZoning = True
    RefreshFolder = True
    PathInputFile = 'Minneberg2D.txt'#'MinnebergLast.txt''Sodermalm4.txt'#'MinnebergLast.txt'#'Pathways_Template.txt'#HammarbyLast.txt'#
