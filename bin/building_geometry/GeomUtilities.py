...
def chekIdenticalpoly(poly1,poly2,tolerance):
    ...
    #polygon are considered identical if there veretx are closer then tolerence in each coordinate
...
def ExtraCheck(poly1,poly2):
    #because it can happen that to identical polygons don't have the same amount of nodees, the function above will not see those as identicial
    Identical = False
