...
## Run simulation case
<python runMUBES.py> will launch the simulation using the geojson file provided as well as all default values form a .yml file (__CoreFile__\__DefaultConfig.yml__)  
